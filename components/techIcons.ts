...
export const TECH_ICONS: Record<string, TechMeta> = {
  ...
  Flask: { Icon: SiFlask, color: "#18180f" },
  ...
  "AWS Lambda": { Icon: FaAws, color: "#F58536" },
  "AWS Amplify": { Icon: FaAws, color: "#FF9900" },
  "Amazon Connect": { Icon: FaAws, color: "#E8890C" },
  "Amazon Kinesis": { Icon: FaAws, color: "#E8890C" },
  "GitHub Actions": { Icon: SiGithubactions, color: "#2088FF" },
  "GitHub Pages": { Icon: SiGithub, color: "#18180f" },
  Render: { Icon: SiRender, color: "#18180f" },
  Aiven: { Icon: FaDatabase, color: "#E1523D" },
  ...
  "AWS Cognito": { Icon: FaShieldAlt, color: "#DD344C" },
  "AWS AppSync": { Icon: SiGraphql, color: "#E10098" },
  ...
  "Machine Learning": { Icon: TbBrain, color: "#E16737" },
