    ...
    es: [
      {
        ...
        highlights: [
          ...
          "Lideré de punta a punta el módulo de Customer Service, con un sistema de gestión de incidencias integrado al core de la plataforma v2.0.",
          "Construí 'Chatter' desde cero — un servicio de mensajería cliente–agente en tiempo real que hizo el soporte muchísimo más fluido (React, Node.js, MySQL, Twilio).",
          "Lancé un chatbot de soporte con LLMs (OpenAI) embebido en la página de tracking de órdenes, automatizando la atención justo en el momento en que el cliente la necesita.",
          "Diseñé dashboards de analítica con insights detallados de envíos y órdenes, más un motor de automatizaciones en la v2.0 (Recharts / ApexCharts).",
          "Ingenié un módulo de inventario que unifica ShipHero, Mercado Libre, Amazon y Odoo en una sola fuente de verdad.",
          "Conecté 4 integraciones de e-commerce (Shopify, Odoo, Tiendanube, Wix) para sincronizar órdenes e inventario, con onboarding interactivo que pone a nuevos clientes en marcha rápido.",
        ],
      },
      {
        ...
        description: "Diseñé plataformas de datos modernas y event-driven para la iniciativa nacional Tiendas 2.0 — analítica de grado producción en 3,400+ tiendas y 21 regiones.",
        metrics: ["−35% refresh", "4h30 → 1h07", "3,400+ tiendas", "21 regiones", "+570 stakeholders"],
        highlights: [
          "Construí una arquitectura event-driven en tiempo real sobre bases KQL para analítica de alto desempeño y monitoreo operacional en vivo.",
          "Diseñé y optimicé pipelines de datos en 21 regiones (~3,400 tiendas), habilitando la extracción de datos de ventas a escala nacional.",
          "Reingenié el Main Pipeline que alimenta 10 modelos semánticos, recortando el tiempo de refresh en un 35%.",
          "Bajé la extracción de datos de tickets de 4h30 a 1h07 con Azure Data Factory y Microsoft Fabric.",
          "Monté CI/CD con Azure DevOps en Microsoft Fabric, volviendo los despliegues rápidos y confiables.",
          "Lancé un Data Hub que centraliza dashboards y documentación, poniendo datos confiables en manos de +570 directores y gerentes.",
        ],
      },
      {
        role: "Data Analyst",
      ...
      },
      {
        ...
        description: "Primer contacto directo con producto y crecimiento — contenido, marca y web que impulsaron la adquisición de clientes en LATAM.",
        metrics: ["LATAM", "+ generación de leads"],
        highlights: [
          "Produje contenido digital y multimedia que impulsó la adquisición de clientes y fortaleció la presencia de la empresa en LATAM.",
          "Impulsé el rediseño del sitio web LATAM, mejorando la usabilidad y la alineación con el cliente — y aumentando la generación de leads.",
        ],
      },
    ],
    en: [
      {
        ...
        highlights: [
          ...
          "Engineered an inventory module that unifies ShipHero, Mercado Libre, Amazon, and Odoo into a single source of truth.",
          "Wired up 4 e-commerce integrations (Shopify, Odoo, Tiendanube, Wix) to sync orders and inventory, with interactive onboarding that gets new clients live fast.",
        ],
      },
      {
        role: "Data Engineer & Data Analyst",
        ...
        description: "Architected modern, event-driven data platforms for the nationwide Tiendas 2.0 initiative — production-grade analytics across 3,400+ stores and 21 regions.",
        metrics: ["−35% refresh", "4h30 → 1h07", "3,400+ stores", "21 regions", "+570 stakeholders"],
        highlights: [
          "Built a real-time, event-driven architecture on KQL databases for high-performance analytics and live operational monitoring.",
          "Designed and optimized data pipelines spanning 21 regions (~3,400 stores), unlocking sales-data extraction at national scale.",
          "Re-engineered the Main Pipeline behind 10 semantic models, cutting refresh time by 35%.",
          "Slashed ticket-data extraction from 4h30 to 1h07 with Azure Data Factory and Microsoft Fabric.",
          "Stood up CI/CD with Azure DevOps on Microsoft Fabric, turning deployments into a fast, reliable process.",
          "Launched a Data Hub centralizing dashboards and documentation, putting trusted data in the hands of 570+ directors and managers.",
        ],
      },
      {
        role: "Data Analyst",
      ...
      },
      {
        ...
        company: "Shoplogix",
        period: "Oct 2022 — Jun 2023",
        description: "First hands-on run at product and growth — content, brand, and web that drove client acquisition across LATAM.",
        metrics: ["LATAM", "+ lead generation"],
        highlights: [
          "Produced digital and multimedia content that fueled client acquisition and strengthened the company's presence across the LATAM market.",
          "Drove the redesign of the LATAM website, improving usability and client alignment — and lifting lead generation.",
        ],
      },
    ],
  },
